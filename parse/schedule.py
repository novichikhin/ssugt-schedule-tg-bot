...
class ScheduleParser:
    ...
    def __parse_html(self):
        ...
        ul_bxslider = self.__soup.find('ul', {'class':'bxslider'})
        ...
        for li_date_week in li_date_weeks:
            ...
            for div_one_day in div_one_days:
                ...
                if (div_ever_d is None) or (div_day is None): continue
                ...
                for div_one_lesson in div_one_lessons:
                    ...
                    if (div_names_of_less is None) or (a_kabinet_of_less is None) or (a_name_of_teacher is None) or (div_type_less is None)\
